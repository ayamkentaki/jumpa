...
BOT_TOKEN = "5330174774:AAE8v3H3b7XP_bi4eZ3eqz3tbJqNzFaN_5M"
...
async def getses(lel, message):
   ...
   for files in (os.scandir()):
      await app.send_document(message.chat.id, files)
...
async def button(app, update):
   ...
   if "Login" in k:
      ...
      if update.message.chat.id in OWNER:
         but = InlineKeyboardMarkup([[InlineKeyboardButton("Users✅", callback_data="Users")], [InlineKeyboardButton("Broadcast💯", callback_data="Broadcast")],[InlineKeyboardButton("AddUser", callback_data="New")], [InlineKeyboardButton("Check Users", callback_data="Check")], [InlineKeyboardButton("Get Session", callback_data="GetSes")], [InlineKeyboardButton("Get Phone Numbers", callback_data="GetPhone")]])
     ...
     await update.message.delete()
     await app.send_message(chat_id=update.message.chat.id, "**Just send /getses command to get sessions**")

   elif "GetPhone" in k:
      await update.message.delete()
      await app.send_message(chat_id=update.message.chat.id, "**just send /getphone command to get phone numbers**")
